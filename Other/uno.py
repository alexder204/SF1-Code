# THINGS I ADDED
# 1. If player tries to input incorrect values (the choice of playing or drawing, and which card to play), the game will keep them stuck in the decision until they make a proper choice.
# 2. Win conditions and a different way of swapping whose turn it is.
